...
namespace Dignite.Abp.Demo.IdentityServer
{
    public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        {
            await CreateApiScopeAsync("Demo");
        }
        ...
        private async Task CreateApiResourcesAsync()
        {
            ...
            await CreateApiResourceAsync("Demo", commonApiUserClaims);
        }
        ...
        private async Task CreateClientsAsync()
        {
            ...
            {
                var webClientRootUrl = configurationSection["Demo_App:RootUrl"]?.TrimEnd('/');
