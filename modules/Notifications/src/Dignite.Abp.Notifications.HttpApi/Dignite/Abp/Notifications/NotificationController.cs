...
namespace Dignite.Abp.Notifications
{
    ...
    public class NotificationController : NotificationsController, INotificationAppService
    {
        ...
        {
            return await _notificationAppService.GetSubscribedAsync();
        }
        ...
        {
            await _notificationAppService.UnsubscribeAsync(notificationName);
        }
        ...
        {
            await _notificationAppService.UpdateStateAsync(notificationId, state);
        }
        ...
        {
            await _notificationAppService.UpdateStatesAsync( state);
        }
        ...
        {
            await _notificationAppService.DeleteAllAsync(state,startDate,endDate);
        }
        ...
        {
            return await _notificationAppService.GetListAsync(state, skipCount, maxResultCount, startDate, endDate);
        }
        ...
        {
            return await _notificationAppService.GetCountAsync(state, startDate, endDate);
        }
