...
{
    public class EfCoreNotificationSubscriptionRepository : EfCoreRepository<INotificationsDbContext, NotificationSubscription>, INotificationSubscriptionRepository
    {
