...
namespace Dignite.Abp.FileManagement
{
    public interface IFilesAppService : IApplicationService
    {
        ...
        /// Return blob url after successful saving
        /// </returns>
        Task<FileDto> SaveAsync([NotNull] string containerName, SaveStreamInput input);
        ...
        /// <returns></returns>
        Task<ListResultDto<FileDto>> GetListAsync([NotNull] string entityType, [NotNull] string entityId);
