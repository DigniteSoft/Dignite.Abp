...
public partial class RoleManagement
{
    ...
    {
        ObjectMapperContext = typeof(DigniteAbpIdentityBlazorModule);
        ...
        EntityActions
            ...
            .AddRange(new EntityAction[]
            {
                    new EntityAction
                    {
                        ...
                        Clicked = async (data) => { await OpenEditModalAsync(data.As<Volo.Abp.Identity.IdentityRoleDto>()); }
                    },
                    new EntityAction
                    {
                        Text = L["Permissions"],
                        ...
                        Clicked = async (data) =>
                        {
                            await PermissionManagementModal.OpenAsync(PermissionProviderName,
                                data.As<Volo.Abp.Identity.IdentityRoleDto>().Name);
                        }
                    },
                    new EntityAction
                    {
                        ...
                        Clicked = async (data) => await DeleteEntityAsync(data.As<Volo.Abp.Identity.IdentityRoleDto>()),
                        ConfirmationMessage = (data) => GetDeleteConfirmationMessage(data.As<Volo.Abp.Identity.IdentityRoleDto>())
                    }
            });
    ...
    protected override string GetDeleteConfirmationMessage(Volo.Abp.Identity.IdentityRoleDto entity)
    {
