...
namespace Dignite.Abp.Identity.IdentityServer;
...
public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        await CreateApiScopeAsync("Identity");
    }
    ...
    private async Task CreateApiResourcesAsync()
    {
        ...
        await CreateApiResourceAsync("Identity", commonApiUserClaims);
    }
    ...
    private async Task CreateClientsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["Identity_App:ClientId"];
        ...
        // Blazor Client
        var blazorClientId = configurationSection["Identity_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["Identity_Blazor:RootUrl"].TrimEnd('/');

            await CreateClientAsync(
                name: blazorClientId,
                scopes: commonScopes,
                grantTypes: new[] { "authorization_code" },
                secret: configurationSection["Identity_Blazor:ClientSecret"]?.Sha256(),
                requireClientSecret: false,
