...
//            components[typeof(UploadBlobStoring)] = typeof(Components.Platform.AntDesign.UploadBlobStoring);
...
//            components[typeof(UploadBlobStoring)] = typeof(Components.Platform.Bootstrap.UploadBlobStoring);
//            foreach (var mapping in components)
//            {
//                serviceCollection.AddTransient(mapping.Key, mapping.Value);
//            }
...
//            components[typeof(UploadBlobStoring)] = typeof(Platform.Bootstrap5.UploadBlobStoring);
//            foreach (var mapping in components)
//            {
//                serviceCollection.AddTransient(mapping.Key, mapping.Value);
//            }
...
//            components[typeof(UploadBlobStoring)] = typeof(Components.Platform.Material.UploadBlobStoring);
//            foreach (var mapping in components)
//            {
//                serviceCollection.AddTransient(mapping.Key, mapping.Value);
//            }
