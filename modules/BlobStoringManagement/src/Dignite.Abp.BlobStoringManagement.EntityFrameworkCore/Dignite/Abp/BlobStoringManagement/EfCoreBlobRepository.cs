...
{
    public class EfCoreBlobRepository : EfCoreRepository<IBlobStoringManagementDbContext, Blob, Guid>, IBlobRepository
    {
        public EfCoreBlobRepository(
            IDbContextProvider<IBlobStoringManagementDbContext> dbContextProvider
            )
