...
namespace Dignite.Abp.SettingManagement
{
    public class SettingManagementPermissionDefinitionProvider : PermissionDefinitionProvider
    {
        public override void Define(IPermissionDefinitionContext context)
        {
            ...
            moduleGroup.AddPermission(SettingManagementPermissions.Global, L("Permission:Settings"), multiTenancySide: MultiTenancySides.Host);    //Whether it is host or tenant, the permission name is L("Settings")
