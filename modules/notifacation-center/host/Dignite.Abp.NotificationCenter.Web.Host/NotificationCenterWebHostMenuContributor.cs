...
{
    public class NotificationCenterWebHostMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public NotificationCenterWebHostMenuContributor(IConfiguration configuration)
        {
        ...
        {
            var l = context.GetLocalizer<NotificationCenterResource>();
