...
using Dignite.Abp.NotificationCenter.Blazor.Server.Host.Menus;
...
namespace Dignite.Abp.NotificationCenter.Blazor.Server.Host
{
    [DependsOn(
        ...
        typeof(NotificationCenterBlazorServerModule)
    )]
    public class NotificationCenterBlazorHostModule: AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    ...
                    typeof(NotificationCenterDomainModule).Assembly,
                    typeof(NotificationCenterDomainSharedModule).Assembly,
                    typeof(NotificationCenterApplicationModule).Assembly,
                    typeof(NotificationCenterApplicationContractsModule).Assembly,
                    typeof(NotificationCenterBlazorHostModule).Assembly
                );
            });
        }
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            Configure<AbpBundlingOptions>(options =>
            {
                ...
                options.StyleBundles.Configure(
                    ...
                    bundle =>
                    {
                        ...
                        bundle.AddFiles("/Dignite.Abp.NotificationCenter.Blazor.Server.Host.styles.css");
                    }
                );
            });
            ...
            if(hostingEnvironment.IsDevelopment())
            {
                Configure<AbpVirtualFileSystemOptions>(options =>
                {
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<NotificationCenterBlazorHostModule>(hostingEnvironment.ContentRootPath);
                });
            }
            ...
            {
                options.AppAssembly = typeof(NotificationCenterBlazorHostModule).Assembly;
            });
